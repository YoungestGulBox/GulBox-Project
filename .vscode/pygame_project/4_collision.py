...
character_y_pos = screen_height - (stage_height + character_heigth)  
...
balls.append({
    ...
    "to_y" : -6,  # Y축 이동방향
    "init_spd_y" : ball_speed_y[0]}) # 각 공에 따른 y의 스피드
    ...
    for event in pygame.event.get(): # 핈수적인 절차
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_LEFT:
                character_to_x -= character_spped
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                   ...
                   balls.append({
                        ...
                        "to_x" : -3,  # 공의 X축 이동방향, -3이면 왼쪽으로, 3이면 오른쪽으로
                        "to_y" : -6,  # Y축 이동방향
                        "init_spd_y" : ball_speed_y[ball_img_idx + 1]}) # 각 공에 따른 y의 스피드
